...
def CreateSpell():
	...
	file.write("\tattackRoll = universal_functions.rollDice(1,20,1,1) + modifyer\n")
	...
	file.write("\t\tdamage = 2*(universal_functions.rollDice(1," + str(damageDice) + "," + str(diceRolls) + "," + str(diceRolls) + "))+modifyer\n")
	...
	file.write("\t\tdamage = universal_functions.rollDice(1," + str(damageDice) + "," + str(diceRolls) + "," + str(diceRolls) + ")+modifyer\n")
